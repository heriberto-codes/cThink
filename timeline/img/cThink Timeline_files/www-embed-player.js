...
;function rg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")},e=!1;if(b){var f="";try{f=(new URL(b,window.location.href)).hostname||""}catch(g){f=(b+"").split("/")[0].split(":")[0]}e="www.youtube-nocookie.com"===f.toLowerCase()}if(e)return d;(b=c.eb||Q("AUTHORIZATION"))||(a?b="Bearer "+w("gapi.auth.getToken")().cb:b=Hc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
